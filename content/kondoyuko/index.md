...
CSSに関しては、簡単なWebサイトのマークアップできる程度の理解があります。
...
それでは、Vivliostyleを用いた簡単な書籍制作の方法を紹介します。
...
そして、``index.html``の、自分の同人誌に必要ない部分をガシガシ削ったり修正したり、本文を流し込んだりしていきましょう。その際、Vivliostyle Viewerで都度確認しながら行うとよいでしょう。
